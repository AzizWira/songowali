...
let questions = [
  {
    ...
    answers: [
      {
        option: "Ja'far Shadiq, putra Sunan Bonang dan Dewi Sartika",
        correct: true,
      },
      {
        option: "Abdul Qadir, putra Sunan Ampel dan Kiai Telingsing",
        correct: false,
      },
      {
        option:
          "Raden Utsman Haji, putra Sunan Ngundung dan Syarifah Dewi Rahil",
        correct: false,
      },
      {
        option: "Muhammad Fakih, putra Sunan Kudus dan Dewi Ratih",
        correct: false,
      },
    ],
  },
  {
    question:
      "Bagaimana Raden Utsman Haji, ayah Sunan Kudus, gugur dalam pertempuran melawan Adipati Terung dari Majapahit?",
    answers: [
      {
        option: "Sunan Ngudung menyerah tanpa melibatkan Raden Utsman Haji",
        correct: false,
      },
      {
        option:
          "Sunan Ngudung menggantikan posisi ayahnya sebagai senopati Demak",
        correct: false,
      },
      {
        option:
          "Raden Utsman Haji gugur dalam pertempuran melawan Adipati Terung",
        correct: true,
      },
      {
        option: "Pertempuran tidak melibatkan ayah Sunan Kudus",
        correct: false,
      },
    ],
  },
  {
    question:
      "Apa versi yang dianggap paling rasional mengenai asal usul Sunan Kudus?",
    answers: [
      { option: "Sunan Kudus berasal dari Persia", correct: false },
      {
        option: "Sunan Kudus adalah keturunan langsung Husain bin Ali",
        correct: false,
      },
      {
        option:
          "Sunan Kudus adalah cucu Sunan Bonang dan keturunan langsung dari Husain bin Ali",
        correct: true,
      },
  ...
  },
  {
    ...
    answers: [
      ...
      {
        option: "Menghindari interaksi dengan masyarakat lokal",
        correct: false,
      },
      {
        option: "Tidak memperhatikan kepercayaan masyarakat setempat",
        correct: false,
      },
    ],
  },
  {
    ...
    answers: [
      ...
      {
        option:
          "Menghargai kepercayaan umat Hindu bahwa sapi merupakan hewan suci",
        correct: true,
      },
  ...
  {
    question:
      "Apa yang dilakukan Sunan Kudus terkait pembangunan menara layaknya candi?",
    answers: [
      { option: "Menunjukkan kekuatan Islam secara fisik", correct: false },
      {
        option: "Menara tersebut hanya sebagai tempat pemakaman raja",
        correct: false,
      },
      {
        option: "Menyesuaikan dengan budaya setempat untuk lebih diterima",
        correct: true,
      },
      {
        option: "Menara tersebut tidak memiliki tujuan khusus",
        correct: false,
      },
    ],
  },
  {
    question:
      "Mengapa Sunan Kudus membuat padasan dengan pancuran berjumlah delapan?",
    answers: [
      { option: "Meniru tradisi Islam", correct: false },
      {
        option: "Upaya melakukan pendekatan terhadap umat Buddha",
        correct: true,
      },
      { option: "Tanpa alasan yang jelas", correct: false },
  ...
  {
    question:
      "Bagaimana Sunan Kudus mengubah acara selamatan mitoni yang dilakukan oleh masyarakat setempat?",
    answers: [
      { option: "Melarang selamatan mitoni sepenuhnya", correct: false },
      { option: "Tidak melakukan perubahan apa pun", correct: false },
      {
        option: "Mengubah doa kepada Allah dan nilai-nilai Islam",
        correct: true,
      },
      {
        option: "Menghapus acara selamatan mitoni dari tradisi lokal",
        correct: false,
      },
    ],
  },
  ...
  {
    question:
      "Apa prinsip utama Sunan Kudus dalam mengajarkan Islam kepada masyarakat?",
    answers: [
      ...
      {
        option: "Tidak melakukan pendekatan kebudayaan dalam dakwah Islam",
        correct: false,
      },
    ],
  },
